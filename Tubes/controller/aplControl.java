...
public class ApkControl {
    ...
    public void dataPengguna() {
        ...
        pengguna2.setIdPengguna("2").setName("Nanda Zacky").setnoHp("0823232323").setEmail("nanda@gmail.com")
                .setPassword("123");
        pengguna3.setIdPengguna("3").setName("Hasna").setnoHp("0834343434").setEmail("hasna@gmail.com")
                .setPassword("234");
        ...
        while (lanjut) {
            ...
            switch (pilihan) {
                case "1.1":
                    ...
                    penggunas.get(index).setPulsaPengguna(-5000);
                    System.out.println();
                    System.out.println("                  PEMBELIAN BERHASIL!                ");
                    lanjut = false;
                    break;
                case "1.2":
                    ...
                    penggunas.get(index).setPulsaPengguna(-10000);
                    System.out.println();
                    System.out.println("                  PEMBELIAN BERHASIL!                ");
                    lanjut = false;
                    break;
                case "1.3":
                    ...
                    penggunas.get(index).setPulsaPengguna(-17000);
                    System.out.println();
                    System.out.println("                  PEMBELIAN BERHASIL!                ");
                    lanjut = false;
                    break;
                case "2.1":
                    ...
                    penggunas.get(index).setPulsaPengguna(-18000);
                    System.out.println();
                    System.out.println("                  PEMBELIAN BERHASIL!                ");
                    lanjut = false;
                    break;
                case "2.2":
                    ...
                    penggunas.get(index).setPulsaPengguna(-25000);
                    System.out.println();
                    System.out.println("                  PEMBELIAN BERHASIL!                ");
                    lanjut = false;
                    break;
                case "2.3":
                    ...
                    penggunas.get(index).setPulsaPengguna(-34000);
                    System.out.println();
                    System.out.println("                  PEMBELIAN BERHASIL!                ");
                    lanjut = false;
                    break;
                case "3.1":
                    ...
                    penggunas.get(index).setPulsaPengguna(-40000);
                    System.out.println();
                    System.out.println("                  PEMBELIAN BERHASIL!                ");
                    lanjut = false;
                    break;
                case "3.2":
                    ...
                    penggunas.get(index).setPulsaPengguna(-54000);
                    System.out.println();
                    System.out.println("                  PEMBELIAN BERHASIL!                ");
                    lanjut = false;
                    break;
                case "3.3":
                    ...
                    penggunas.get(index).setPulsaPengguna(-68000);
                    System.out.println();
                    System.out.println("                  PEMBELIAN BERHASIL!                ");
                    lanjut = false;
                    break;
